...
elizabeth_image = face_recognition.load_image_file("elizabeth.jpg")
elizabeth_face_encoding = face_recognition.face_encodings(elizabeth_image)[0]

emma_image = face_recognition.load_image_file("emma.jpg")
emma_face_encoding = face_recognition.face_encodings(emma_image)[0]

gal_image = face_recognition.load_image_file("gal.jpg")
gal_face_encoding = face_recognition.face_encodings(gal_image)[0]

margot_image = face_recognition.load_image_file("margot.jpg")
margot_face_encoding = face_recognition.face_encodings(margot_image)[0]
